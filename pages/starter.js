		...
		<>
			...
			<main className="main main--blog">
				...
				<div className="blog__body">
					...
					<div className="blog__invest-dummy">
					...
					<br />
					<p className="blog__stocks">
						{" "}
						The act of buying <span className="keyword--black">
							portions
						</span>{" "}
					...
					<div className="blog__intelligent">
						{" "}
